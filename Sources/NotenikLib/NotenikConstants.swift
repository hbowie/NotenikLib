...
public struct NotenikConstants {
    ...
    public static let authorInfo        = "Author Info"
    public static let authorInfoCommon  = "authorinfo"
    public static let authorLinkCommon  = "authorlink"
    public static let authorYears       = "Author Years"
    public static let authorYearsCommon = "authoryears"
    ...
    public static let imageLayout       = "Image Layout"
    public static let imageLayoutCommon = "imagelayout"
    ...
    public static let inclusions        = "Inclusions"
    public static let inclusionsCommon  = "inclusions"
    public static let includedBy        = "Included By"
    public static let includedByCommon  = "includedby"
    ...
    public static let scriptCommon  = "script"
    public static let spokenCommon  = "spoken"
    ...
    public static let authorWorkSlugIntLinksCommon = "authorworkslugintlinks"
    public static let finishedWorkSlugCommon = "finishedworkslug"
    ...
    public static let seqFormattedCommon   = "seqformatted"
    ...
    public static let slideKlass        = "slide"
    public static let titleKlass        = "title"
    public static let titlePageKlass    = "title-page"
    ...
    static let dailyNotesCommon         = "dailynotes"
